// Comprehensive image serving diagnosis
async function diagnoseImageServing() {
  console.log('🔍 Comprehensive Image Serving Diagnosis\n');
  ...
  try {
    ...
    try {
      ...
      console.log('   🔧 Check your S3 credentials and bucket permissions');
      return;
    }

    console.log('\n3️⃣  Testing Serve-Image API:\n');
    ...
    console.log('4️⃣  Analyzing API Results:\n');
    ...
    console.log('\n5️⃣  Testing Direct S3 Access:\n');
    
    // Test direct S3 access for failed images
    if (failed.length > 0) {
      console.log('🔍 Testing direct S3 access for failed images...');
      ...
      for (const failedImage of failed.slice(0, 3)) { // Test first 3 failed images
        console.log(`🧪 Testing S3 access: ${failedImage.key}`);
        ...
        try {
          ...
          console.log(`   🚨 Error: ${s3Error.message}`);
          console.log(`   🔧 Error Code: ${s3Error.Code || 'N/A'}`);
          console.log(`   📍 Error Name: ${s3Error.name || 'N/A'}`);
          
          if (s3Error.Code === 'NoSuchKey') {
            console.log(`   💡 Solution: Image file does not exist in S3`);
          } else if (s3Error.Code === 'AccessDenied') {
            console.log(`   💡 Solution: Check S3 bucket permissions`);
          } else if (s3Error.Code === 'InvalidBucketName') {
            console.log(`   💡 Solution: Check S3 bucket name`);
          } else {
            console.log(`   💡 Solution: Check S3 configuration`);
          }
        }
    ...
    console.log('   3. Test S3 connection directly');
    ...
    console.log('   7. Monitor server logs');
